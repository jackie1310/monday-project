export default function Button ({label, type, click, disable}) {
    ...
    switch (type) {
        ...
        case "responsive":
            ...
            break;
        case "front":
            style = "flex gap-1 items-center absolute -bottom-16 md:-bottom-24 right-10 px-4 bg-blue-500 text-white";
            break;
        case "back":
            style = "flex gap-1 items-center absolute -bottom-16 md:-bottom-24 left-10 px-4 border border-gray-400 bg-white text-black"
    }
    return (
