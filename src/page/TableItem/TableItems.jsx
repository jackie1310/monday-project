        ...
        <div className="md:flex block">
            <div className="md:w-1/2 w-full relative px-10 pt-20 mb-32">
                <div className="w-5/6">
                    ...
                    <Radio.Group value={selectedItem} onChange={e => setSelectedItem(e.target.value)} className="flex gap-5 justify-between mb-5">
                        <Radio value="Projects" className={style}>Projects</Radio>
                        <Radio value="Tasks" className={style}>Tasks</Radio>
                        <Radio value="Custom"><p className="border pl-3 py-1 pr-5 rounded-md">Custom</p></Radio>
                    </Radio.Group>
